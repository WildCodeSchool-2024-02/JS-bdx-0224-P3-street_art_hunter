    ...
    <>
      ...
      <section className="thankyou-page">
        ...
        <p className="p-thankyou">
          PixHunt est fier de vous offrir les oeuvres d'art de rue de Bordeaux.
          Grâce à vos contributions, nous pouvons intégrer les nouvelles oeuvres
          créées les plus récentes.
        </p>
        <h2 className="thankyou-title">
        ...
        <h2 className="thankyou-title">
          Et enfin, un grand remerciement à Adrien, Alice, Chris et Kévin de la
          Wild Code School pour avoir réalisé ce projet.
        </h2>
      </section>
